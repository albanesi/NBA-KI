...
# === Champion pro Jahr definieren (manuell) ===
champions = {
    "2018": "GSW",
    "2019": "TOR",
    "2020": "LAL",
    ...
    "2022": "GSW",
    "2023": "DEN"
    # 2024 intentionally left out (aktuelles Jahr = prediction target)
}
...
# === Alle Teams abrufen (für ID → Code, Name, Logo)
...
for season in range(2018, 2025):
    ...
    for entry in standings_response:
        ...
        if not info:
            print(f"⚠️ Team ID {team_id} nicht in Teamliste gefunden")
            continue
        ...
        doc = {
            ...
            # Label: champion = 1 wenn Team Meister war, sonst 0
